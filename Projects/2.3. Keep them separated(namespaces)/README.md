...
## Objective
The goal of this exercise is to organize and isolate cluster workloads using Kubernetes **Namespaces**. Instead of deploying everything into the `default` namespace, the applications created in Exercise 2.1 (Log Output and Ping Pong) are migrated into a dedicated namespace named `exercises`.

## Architecture and Networking
Follow the Excercise 2.1 for application architecture and detail working , the excercise 2.1 section below
